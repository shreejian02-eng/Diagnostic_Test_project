...
const Results: React.FC<ResultsProps> = ({ analytics, onRestart }) => {
  const data = [
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4 md:p-8 space-y-8 animate-pop">
      {/* Header Card */}
      <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-xl p-8 text-center border-b-8 border-brand-500 transition-colors">
